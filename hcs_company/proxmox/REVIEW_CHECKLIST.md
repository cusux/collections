...
When reviewing, keep in mind that we follow [Ansible Guidelines](link_to_be_provided) in all our contributions and interactions within this repository.

If you are a committer, also refer to the [Working with Git and GitLab Guidelines](link_to_be_provided).
